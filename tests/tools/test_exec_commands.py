...
class TestCommandExecutorTool:
    ...
    @patch('platform.system')
    @patch('subprocess.run')
    def test_execute_command_failed_with_output(self, mock_subprocess_run, mock_platform_system):
    ...
    @patch('platform.system')
    @patch('subprocess.run')
    def test_execute_invalid_command_windows(self, mock_subprocess_run, mock_platform_system):
    ...
    @patch('platform.system')
    @patch('subprocess.run')
    def test_execute_invalid_command_unix(self, mock_subprocess_run, mock_platform_system):
