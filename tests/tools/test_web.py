...
class TestWebSearchTool:
    ...
    def test_execute_dict_response(self, mock_ollama):
        ...
        mock_ollama.web_search.return_value = {
            "results": [
                {"title": "Dict Result", "url": "http://dict.com", "content": "Dict content"}
            ]
        }
    ...
    def test_execute_list_response(self, mock_ollama):
        ...
        mock_ollama.web_search.return_value = [
            {"title": "List Result", "url": "http://list.com", "content": "List content"}
        ]
    ...
    def test_execute_no_web_search_function(self, mock_ollama):
        ...
        with pytest.raises(NotImplementedError, match="ollama.web_search is not available"):
    ...
    async def test_aexecute(self, mock_ollama):
        ...
        mock_result = Mock()
        mock_result.results = [{"title": "Async Result", "url": "http://async.com", "content": "Async content"}]
        mock_ollama.web_search.return_value = mock_result
...
class TestWebFetchTool:
    ...
    def test_execute_success(self, mock_ollama):
        ...
        mock_ollama.web_fetch.return_value = {
    ...
    def test_execute_no_web_fetch_function(self, mock_ollama):
        ...
        with pytest.raises(NotImplementedError, match="ollama.web_fetch is not available"):
