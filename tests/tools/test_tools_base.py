...
class TestToolResult:
    ...
    def test_tool_result_to_anthropic_format(self):
        ...
        result = ToolResult(tool_call_id="call_123", content="Success", status="success")
...
class TestToolRegistry:
    ...
    async def test_arun_registered_tool(self):
        ...
        tool_call = ToolCall(
            id="call_123",
            name="test_tool",
            arguments={"param1": "async_run_value"}
        )
