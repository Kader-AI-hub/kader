...
class OllamaProvider(BaseLLMProvider):
    ...
    def _convert_config_to_options(self, config: ModelConfig) -> Options:
        ...
        return Options(
            ...
            top_k=config.top_k,
            frequency_penalty=config.frequency_penalty if config.frequency_penalty != 0.0 else None,
            presence_penalty=config.presence_penalty if config.presence_penalty != 0.0 else None,
