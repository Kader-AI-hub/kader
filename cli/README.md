...
When you start a conversation, Kader automatically generates a title based on your first message. Session titles are displayed:

- In the session list when using `/sessions`
