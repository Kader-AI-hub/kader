...
from kader.tools import ToolRegistry, get_filesystem_tools, CommandExecutorTool, WebSearchTool, WebFetchTool
...
async def main():
    ...
    print(f"Agent '{agent.name}' initialized with tools: {list(agent.tools_map.keys())}")
